...
const leadTransitions: Record<string, string[]> = {
  DRAFT: ["NEW"],
  NEW: ["ASSIGNED", "WORKING", "INTERESTED", "DISQUALIFIED"],
  ASSIGNED: ["WORKING", "INTERESTED", "QUALIFIED", "DISQUALIFIED"],
  WORKING: ["INTERESTED", "QUALIFIED", "DISQUALIFIED"],
  INTERESTED: ["QUALIFIED", "DISQUALIFIED"],
