module.exports = [
  ...
  { code: "config:approval:read", name: "Approval Config Read", type: "ACTION" },
  { code: "config:approval:write", name: "Approval Config Write", type: "ACTION" },
  { code: "alert:read", name: "Alert Config Read", type: "ACTION" },
  { code: "alert:write", name: "Alert Config Write", type: "ACTION" },
  { code: "approval:read", name: "Approval Read", type: "ACTION" },
  { code: "approval:write", name: "Approval Write", type: "ACTION" },
